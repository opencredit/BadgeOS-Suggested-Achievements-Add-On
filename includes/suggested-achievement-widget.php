...
class suggested_achievements_widget extends WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p><label><input type="checkbox" id="<?php echo $this->get_field_name( 'point_total' ); ?>"
                         name="<?php echo $this->get_field_name( 'point_total' ); ?>" <?php checked( $point_total, 'on' ); ?> /> <?php _e( 'Display user\'s total points', 'badgeos-suggested-achievements' ); ?>
            </label></p>
